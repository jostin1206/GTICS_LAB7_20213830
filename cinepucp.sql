...
INSERT INTO cinepucp.movies (title, description, duration, releaseDate)
VALUES 
('Megamente', 'Un supervillano se convierte en el héroe de la ciudad', 12, '2024-10-10');

UPDATE `cinepucp`.`rooms` SET `id` = '1' WHERE (`id` = '2');
UPDATE `cinepucp`.`movies` SET `id` = '1' WHERE (`id` = '2');

INSERT INTO cinepucp.rooms (name, capacity)
VALUES 
('Sala 1', 2);

INSERT INTO cinepucp.movieprojections (movieId, roomId, projectionDate, availableSeats)
VALUES 
(1, 1, '2024-10-09 01:47:00', 3);
